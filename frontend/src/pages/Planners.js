...
import { AddPlannerModal } from '../modals/AddPlannerModal'
import { EditPlannerModal } from '../modals/EditPlannerModal'
import { DetailsPlannerModal } from '../modals/DetailsPlannerModal'
import { SearchPlannerModal } from "../modals/SearchPlannerModal";
...
export class Planners extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            planners: [], addModalShow: false, editModalShow: false, detailsModalShow: false,
